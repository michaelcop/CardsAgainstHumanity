...
//? User=UserId&GameID=gameid
//Returns Success


@WebServlet(urlPatterns={"/QuitGame"})
public class QuitGame extends HttpServlet implements DataSource {
	/**
	 * 
	 */
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(connection != null){
				...
				try {
					...
					//QUERY NEEDS TO UPDATE PLAYERS IN GAME BY REMOVING THE USERID SENT
